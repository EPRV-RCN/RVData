...
def convert_RAW(RV2: RV2, file_path: str) -> None:
    ...
    This function reads a FITS file, extracts the relevant data from configured extensions, 
    and adds or updates them in the given RV2 object. It supports both image (IMAGEHDU) 
    and binary table (BINTABLEHDU) extensions.

    Parameters:
        RV2 (RV2): The RV2 object where the converted data will be stored.
        file_path (str): Path to the FITS file to be processed.
    Returns:
        None : The function modifies the RV2 object in place by adding or updating the extnames_raw extensions.
    """
