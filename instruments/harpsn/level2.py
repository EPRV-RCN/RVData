...
class HARPSNRV2(RV2):
    """
    Read HARPSN Level 1 and Level 2 files and convert them into the EPRV standard format.

    This class extends the `RV2` base class to handle the reading of HARPSN (High Accuracy 
    Radial velocity Planet Searcher North) Level 1 and Level 2 files, combining information from 
